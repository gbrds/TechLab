...
function Home() {
  ...
  // Kaustad ja navigatsioon
  const baseFolders = [
    {
      id: 1,
      name: "UX/UI Disaineri nooremspetsialist",
      route: "/ux-ui",
      unlocked: true,
      progress: 0,
    ...
    {
      id: 2,
      name: "Tarkvaraarendaja nooremspetsialist",
      route: "/tarkvara",
      unlocked: false,
      progress: 0,
    ...
    {
      id: 4,
      name: "IT-Süsteemide nooremspetsialist",
      route: "/ITSpetsialist",
      unlocked: false,
      progress: 0,
  ...
  const handleFolderClick = (folder) => {
    if (folder.unlocked) navigate(folder.route);
  };
