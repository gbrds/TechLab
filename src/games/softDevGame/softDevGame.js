...
export default class CodeFinder extends Phaser.Scene {
  ...
  preload() {
    // Make sure softDevGame.json is in the public folder
  ...
  create() {
    ...
    // Input field
    this.inputArea = this.add.dom(400, 400, "input", {
      type: "text",
    ...
    // Submit button
    this.submitBtn = this.add.text(640, 400, "Submit", {
      fontFamily: "monospace",
      fontSize: "20px",
      color: "#00ff00",
      backgroundColor: "#222"
    }).setInteractive().on("pointerdown", () => this.checkAnswer());
